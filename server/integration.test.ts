...
describe("Integration & End-to-End simulation of agent calculations and HITL rules", () => {
  it("simula una determinación impositiva elevada que activa el circuito de aprobación humana", () => {
    const calculation = calculateDeterministicAccounting({
  ...
  it("simula una liquidación salarial por debajo del umbral que se completa automáticamente", () => {
    const calculation = calculateDeterministicAccounting({
